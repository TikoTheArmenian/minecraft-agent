...
const skills = [
  ...
  },
  {
    ...
    description: 'Find the nearest sponge and move beside or onto it. Watches for new or moved sponge blocks until Stop.',
    limits: 'Continuously scans loaded terrain within 64 blocks for dry or wet sponge. Stop cancels.',
  ...
  },
  {
    ...
    className: 'Survival',
    taskSkill: 'SURVIVE',
    description: 'Gathers supplies, crafts tools, then expands and harvests a wheat farm toward 128 wheat.',
    limits: 'Starter routine · up to 20 minutes · resources within 80 blocks. Stop the selected bot cancels the skill.',
  ...
  },
  {
    ...
    className: 'WheatFarm',
    taskSkill: 'FARMER',
    description: 'Continuously expands, harvests and replants wheat, and stores surplus in chests. Runs until Stop.',
    limits: 'Continuous production within 80 blocks. Surfaces to restore low air, then resumes. Stop the selected bot cancels the skill.',
  ...
  },
  {
    ...
    description: 'Mine whole trees from the base upward, climb with dirt, recover the climbing blocks and replant matching saplings.',
    limits: 'Continuous tree farming. Keeps a 32-dirt reserve, mines from the base upward, recovers climbing blocks and replants. Stop cancels.',
  ...
  },
  {
    ...
    limits: 'Gets 16 torches from coal or charcoal. Requires Survival mode. Stop cancels the skill.',
  ...
  },
  {
    ...
    description: 'Inspect shared chests, store surplus, organize managed storage and fulfill crafting jobs.',
    limits: 'Shared managed chests within 80 blocks. Requires Supabase configuration. Stop cancels.',
  ...
  },
  {
    ...
    description: 'Locates exposed ores in loaded terrain, mines the reachable ones safely, and stores the raw ore in shared storage.',
    limits: 'Loaded terrain within 80 blocks of start. Never digs straight down or into liquids. Stop cancels.',
  ...
  },
  {
    ...
    description: 'Harvests grown sugar cane above the base, replants along water, expands the patch, and stores surplus.',
    limits: 'Continuous production near water within 80 blocks of start. Keeps the growing base. Stop cancels.',
  ...
  },
  {
    ...
    description: 'Hunts hostile mobs near its post with the best weapon, retreats and eats when hurt, collects drops, and stores surplus.',
    limits: 'Hostile mobs only, within a bounded patrol radius. Never attacks players or passive animals. Stop cancels.',
  ...
  },
  {
    ...
    description: 'Levels a selected rectangle to a target height: cuts blocks above, fills below with building blocks from inventory or shared storage.',
    limits: 'Bounded rectangle within 64 blocks. Budgets fill material before digging. Stop cancels; rerunning resumes.',
  ...
  },
  {
    ...
    parser: 'parseSmelter',
    taskSkill: 'SMELTER',
    description: 'Retrieves raw ores, sand, logs and raw food plus fuel from shared storage, runs furnaces near the hub, and stores the output.',
    limits: 'Furnaces within the storage area. Confirms every input, fuel and output transfer. Stop cancels while waiting.',
...
module.exports = { skills, skillFor, skillForAlias, parseSkill, publicSkills }
