...
module.exports = [
  { ignores: ['node_modules/**', 'data/**', 'public/textures/**', 'public/dist/**'] },
  ...
  { files: ['public/**/*.mjs'], ...js.configs.recommended, languageOptions: { sourceType: 'module', globals: { ...globals.browser, botUrl: 'readonly' } } },
